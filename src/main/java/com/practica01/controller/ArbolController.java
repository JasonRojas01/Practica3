...
public class ArbolController {
    ...
    public String listado(Model model){
        var arbols = arbolService.getArboles(false);
        model.addAttribute("arboles", arbols);
        model.addAttribute("totalArboles", arbols.size());
    ...
    public String arbolModificar(@ModelAttribute Arbol arbol, Model model) {
